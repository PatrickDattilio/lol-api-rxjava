...
public class RawStatsDto {
    ...
    private int barracksKilled = -1;
    private int championsKilled = -1;
    private int totalDamageDealtToChampions = -1;
    private int combatPlayerScore = -1;
    private int consumablesPurchased = -1;
    private int damageDealtPlayer = -1;
    private int doubleKills = -1;
    private int firstBlood = -1;
    private int gold = -1;
    private int goldEarned = -1;
    private int goldSpent = -1;
    private int item0 = -1;
    private int item1 = -1;
    private int item2 = -1;
    private int item3 = -1;
    ...
    private int item5 = -1;
    private int item6 = -1;
    private int itemsPurchased = -1;
    private int killingSprees = -1;
    private int largestCriticalStrike = -1;
    private int largestKillingSpree = -1;
    private int largestMultiKill = -1;
    private int legendaryItemsCreated = -1;
    private int level = -1;
    private int magicDamageDealtPlayer = -1;
    private int magicDamageDealtToChampions = -1;
    private int magicDamageTaken = -1;
    private int minionsDenied = -1;
    private int minionsKilled = -1;
    private int neutralMinionsKilled = -1;
    private int neutralMinionsKilledEnemyJungle = -1;
    private int neutralMinionsKilledYourJungle = -1;
    private boolean nexusKilled = false;
    private int nodeCapture = -1;
    private int nodeCaptureAssist = -1;
    private int nodeNeutralize = -1;
    private int nodeNeutralizeAssist = -1;
    private int numDeaths = -1;
    private int numItemsBought = -1;
    private int objectivePlayerScore = -1;
    private int pentaKills = -1;
    private int physicalDamageDealtPlayer = -1;
    private int physicalDamageDealtToChampions = -1;
    private int physicalDamageTaken = -1;
    private PlayerPosition playerPosition = null;
    private PlayerRole playerRole = null;
    private int quadraKills = -1;
    private int sightWardsBought = -1;
    private int spell1Cast = -1;
    private int spell2Cast = -1;
    private int spell3Cast = -1;
    private int spell4Cast = -1;
    private int summonSpell1Cast = -1;
    private int summonSpell2Cast = -1;
    private int superMonsterKilled = -1;
    private int team = -1;
    private int teamObjective = -1;
    private int timePlayed = -1;
    private int totalDamageDealt = -1;
    private int totalDamageTaken = -1;
    private int totalHeal = -1;
    private int totalPlayerScore = -1;
    private int totalScoreRank = -1;
    private int totalTimeCrowdControlDealt = -1;
    private int totalUnitsHealed = -1;
    private int tripleKills = -1;
    private int trueDamageDealtPlayer = -1;
    private int trueDamageDealtToChampions = -1;
    private int trueDamageTaken = -1;
    private int turretsKilled = -1;
    private int unrealKills = -1;
    private int victoryPointTotal = -1;
    private int visionWardsBought = -1;
    private int wardKilled = -1;
    private int wardPlaced = -1;
